		...
		Для Каждого ИмяРеквизита Из МассивИменаРеквизитов Цикл
			...
			Иначе
				Если МассивИменаРеквизитов.Количество() > 1 Тогда
					Для Каждого ЭлементСтруктуры Из ДанныеСтрокиСтарые Цикл
						СтруктураОбработчиков.ИзмененныеРеквизиты.Вставить(ЭлементСтруктуры.Ключ, ЭлементСтруктуры.Значение);
					КонецЦикла;
				Иначе
...
Функция ПолучитьСтруктуруОбработчиков()
	Возврат Новый Структура("Результаты,Параметры,ЗависимостиПрямые,ЗависимостиОбратные,Свойства,СвойстваКОбновлению,Идентификаторы,ТекущиеИдентификаторы,ИзмененныеРеквизиты"
			,Новый Соответствие, Новый Соответствие, Новый Соответствие, Новый Соответствие, Новый Соответствие, Новый Соответствие, Новый Соответствие, Новый Соответствие, Новый Соответствие);
КонецФункции
