...
//
Функция глМодель_НачатьИзменения(Знач ФормаОбъект, ОбрабатыватьИзмененныеТаблицыПриЗавершении = Истина, ТолькоПросмотр = Ложь) Экспорт
	...
	КонтекстИзменений = ИнициализироватьКонтекстИзменений(ФормаОбъект, , ТолькоПросмотр);
	ДанныеКонтекста = ДанныеКонтекста(КонтекстИзменений);
...
Функция ИнициализироватьКонтекстИзменений(ОбъектФорма, ИнициализацияФормы = Ложь, ТолькоПросмотр = Ложь)
