...
Функция ПолучитьПараметрыМодели(ОбъектФорма) Экспорт
	СтруктураРезультат = Новый Структура("Опции,ИменаТаблиц,ДобавленныеРеквизиты,ДобавленныеРеквизитыТаблицы,ЕстьРеквизитыВместе,ЕстьРеквизитыОтдельно,ИмяОбъекта"
